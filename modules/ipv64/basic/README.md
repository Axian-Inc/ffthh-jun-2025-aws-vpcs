...
This creates an IPv6 VPC with just Public Subnets, similar to the default IPv4 VPCs provided by AWS. This uses a NAT Gateway in each AZ for doing NAT64 for the respective Subnets.
