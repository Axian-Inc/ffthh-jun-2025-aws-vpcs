locals {
  ...
  public_subnet_divisions   = [for subnet_name in local.public_subnet_names : { name = subnet_name, new_bits = var.public_subnet_bit_shift }]
  ...
  private_subnet_divisions   = [for subnet_name in local.private_subnet_names : { name = subnet_name, new_bits = var.private_subnet_bit_shift }]
}
