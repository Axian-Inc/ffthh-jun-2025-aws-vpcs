...
variable "public_ipv4_cidr_block_shift" {
  type        = number
  description = "Number of bits to shift from the VPC IPv4 CIDR block to generate the public CIDR block"
  default     = 1
}

variable "public_subnet_ipv4_bit_shift" {
  type        = number
...
variable "private_ipv4_cidr_block_shift" {
  type        = number
  description = "Number of bits to shift from the VPC IPv4 CIDR block to generate the private CIDR block"
  default     = 1
}

variable "private_subnet_ipv4_bit_shift" {
  type        = number
