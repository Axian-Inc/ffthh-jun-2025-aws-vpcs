...
# Create the public IP address for each NAT Gateway
...
# Associate the Route Tables with each Private Subnet
...
# Create the default routes for IPv4 NATing
...
# Create the default routes for IPv6 Egress-Only
